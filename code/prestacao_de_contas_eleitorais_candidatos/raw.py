...
BASE_URL = f"https://cdn.tse.jus.br/estatistica/sead/odsele/prestacao_contas/prestacao_de_contas_eleitorais_candidatos_{{year}}.zip"

TARGET_FOLDER = get_path("/data/prestacao_de_contas_eleitorais_candidatos/raw/")
